...
!function () {
    ...
    for (var o = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, l = {
        L: 1,
        M: 0,
        Q: 3,
        H: 2
    ...
    var i, n, a, l = Array.prototype.indexOf, u = Object.assign, c = /MicroMessenger/i.test(navigator.userAgent),
        f = o.documentElement.clientWidth <= 768, t = (o.images[0] || 0).src || "",
        e = v("site") || v("Site") || o.title, s = v("title") || v("Title") || o.title,
        ...
        (t = "string" == typeof t ? m(t) : t).length === h && (t = [t]), C(t, function (t) {
            t.initialized || function (t, e) {
                ...
                (function (t, e) {
                    ...
                    var n, o,
                        e = (n = t, (o = a).summary || (o.summary = o.description), p[n].replace(/\{\{(\w)(\w*)\}\}/g, function (t, e, r) {
